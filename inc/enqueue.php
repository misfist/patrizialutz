 ...
 */
 ...
 function patrizialutz_scripts() {
  ...
  $version = rand ( 2001, 6000 );
	...
	wp_enqueue_style( 'patrizialutz-style', get_template_directory_uri() . '/css/main.css', array(), $version, 'all');

	wp_enqueue_script( 'patrizialutz-scripts', get_template_directory_uri() . '/js/min/main.min.js', array ( 'jquery' ), 1.0, true);
