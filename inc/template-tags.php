...
if ( ! function_exists( 'patrizialutz_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function patrizialutz_posted_on() {
...
if ( ! function_exists( 'patrizialutz_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function patrizialutz_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'patrizialutz_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function patrizialutz_entry_footer() {
...
if ( ! function_exists( 'patrizialutz_post_thumbnail' ) ) :
/**
 ...
 */
function patrizialutz_post_thumbnail() {
